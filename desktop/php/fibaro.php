...
foreach ($eqLogics as $eqLogic) {  
  $opacity = ($eqLogic->getIsEnable()) ? '' : 'disableCard';
	...
	echo '<img src="' . $eqLogic->getImage() . '" height="95" width="95" />';
	echo '<br>';
...
?>
	...
	<div class="form-group">
       ...
       <div class="form-group">
        ...
        <div class="col-sm-3">
            <input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="fibaroIdModule" placeholder="ID du Module Fibaro"/>
        </div>
    </div>
</fieldset>
</form>
...
<?php include_file('desktop', 'fibaro', 'js', 'fibaro');?>
